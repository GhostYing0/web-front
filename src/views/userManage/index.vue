<template>
    <div class="app-container">
        <div class="filter-container" style="margin-bottom: 15px">
            ...
            <el-button v-waves class="filter-item" type="primary" style="font-size: 20px;" icon="el-icon-a-041" @click="handleShowUser(1)">
                显示学生
            </el-button>
            <el-button v-waves class="filter-item" type="primary" style="font-size: 20px;" icon="el-icon-a-041" @click="handleShowUser(2)">
                显示教师
            </el-button>
    ...
    <el-table
        ...
        <el-table-column
            ...
            <template #default="{ row }">
                <el-tag v-if="row.Role === 1" type="info">学生</el-tag>
                <el-tag v-else type="success">教师</el-tag>
            </template>
        </el-table-column>
...
<script>
    import {getUser, addUser, getUserCount, deleteUsers,updateUser} from '@/api/user'
