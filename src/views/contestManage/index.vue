<template>
    <div class="app-container">
        <div class="filter-container" style="margin-bottom: 15px">
            ...
            <el-input v-model="param.type" placeholder="类型" style="width: 200px;" class="filter-item" @keyup.enter.native="handleFilter" />
            <div class="block">
...
<script>
    import {getContest, addContest, deleteContest, updateContest, getCount} from '@/api/contest'
